...
@section('content')
    ...
    <div class="dashboard-main-body">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Users Guru</h6>
        ...
        <div class="card basic-data-table">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">Data Users Guru</h5>
                <div>
 ...
 <iconify-icon icon="ion:search-outline" class="icon"></iconify-icon>
    ...
    <button type="button"
        ...
        data-url="{{ route('admin.users.guru.aktifkansemua') }}"
    ...
    <button type="button"
        ...
        data-url="{{ route('admin.users.guru.nonaktifkansemua') }}"
...
$(document).on('click', '.btn-toggle-all', function () {
    ...
    let text = action === 'activate'
        ? 'Semua guru akan diaktifkan'
        : 'Semua guru akan dinonaktifkan';
