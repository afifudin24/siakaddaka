...
@section('content')
    ...
    <div class="dashboard-main-body">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Users Staff</h6>
        ...
        <div class="card basic-data-table">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">Data Users Staff</h5>
                <div>
 ...
 <iconify-icon icon="ion:search-outline" class="icon"></iconify-icon>
    ...
    <button type="button"
        ...
        data-url="{{ route('admin.users.staff.aktifkansemua') }}"
    ...
    <button type="button"
        ...
        data-url="{{ route('admin.users.staff.nonaktifkansemua') }}"
                        ...
                        <table class="table basic-border-table" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="" style="width : 40px !important;">AKSI</th>
...
$(document).on('click', '.btn-toggle-all', function () {
    ...
    let text = action === 'activate'
        ? 'Semua staff akan diaktifkan'
        : 'Semua staff akan dinonaktifkan';
