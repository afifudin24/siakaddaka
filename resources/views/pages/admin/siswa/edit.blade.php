...
@section('content')
    <div class="dashboard-main-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h5>Edit Siswa</h5>
            <a href="{{ route('admin.siswa.index') }}" class="btn btn-danger btn-sm d-flex align-items-center gap-2">
                        ...
                        <div class="user-guruid-card ">
                            <div class="position-relative border radius-16 overflow-hidden">
                                ...
                                <div class="ps-16 pb-16 pe-16 text-center mt--50">
                                    ...
                                    <img src="{{ foto_profil($siswa) }}"
                                        class="border br-white border-width-2-px w-100-px h-100-px rounded-circle object-fit-cover">

                                    <h6 class="text-lg mb-0 mt-4">{{ $siswa->nama }}</h6>
                                    <span class="text-secondary-light mb-16">{{ $siswa->user->email }}</span>
                            ...
                            <div class="row  mt-1 md-mt-16 text-center d-flex justify-content-center">
  ...
  @method('PUT')
              ...
              <div class="col-sm-10">
                <div class="icon-field">
                  ...
                  <input type="text" name="nama" class="form-control" placeholder="Masukkan Nama" value="{{$siswa->nama}}">
                </div>
              </div>
            </div>
                                 <div class="row mb-2 gy-3 d-flex align-items-center">
              ...
              <div class="col-sm-10">
                <div class="icon-field">
                  ...
                  <input type="text" name="username" class="form-control" placeholder="Masukkan Username" value="{{$siswa->user->username}}">
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-10">
                <div class="icon-field">
                  ...
                  <input type="email" name="email" class="form-control" placeholder="Masukkan Email" value="{{$siswa->user->email}}">
                </div>
              </div>
            </div>
                                 <div class="row mb-2 gy-3 d-flex align-items-center">
              ...
              <div class="col-sm-10">
                <div class="icon-field">
                  ...
                  <input type="text"  class="form-control" placeholder="Masukkan No. HP" value="{{$siswa->no_hp}}" name="no_hp">
                </div>
              </div>
            </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="pills-details" role="tabpanel"
                                ...
                                <div>
                                     <div class="row mb-2 gy-3 d-flex align-items-center">
              <label class="form-label mb-0 col-sm-2">NIS</label>
              <div class="col-sm-10">
                <div class="icon-field">
                  <span class="icon">
                  ...
                  <input type="text" name="nis" class="form-control" placeholder="Masukkan NIS" value="{{$siswa->nis}}">
                </div>
              </div>
            </div>
                                     <div class="row mb-2 gy-3 d-flex align-items-center">
              <label class="form-label mb-0 col-sm-2">NISN</label>
              <div class="col-sm-10">
                <div class="icon-field">
                  <span class="icon">
                    <iconify-icon icon="hugeicons:identity-card"></iconify-icon>
                  </span>
            
                  <input type="text" name="nisn" class="form-control" placeholder="Masukkan NISN" value="{{$siswa->nisn}}">
                </div>
              </div>
            </div>
                                     <div class="row mb-2 gy-3 d-flex align-items-center">
              ...
              <div class="col-sm-10">
                <div class="icon-field">
                  ...
                  <!-- <input type="text" name="#0" class="form-control" placeholder="Masukkan Alamat" value="{{$siswa->alamat}}"> -->
                </div>
              </div>
            </div>
                  <div class="row mb-2 gy-3 d-flex align-items-center">
              ...
              <div class="col-sm-10">
                <div class="icon-field">
                 ...
                 <input type="date" name="tgl_lahir" id="tgl_lahir" class="form-control" value="{{$siswa->tgl_lahir}}">
                                     ...
                                     <div class="row mb-2 gy-3 d-flex align-items-center">
              <label class="form-label mb-0 col-sm-2">NO HP Orang Tua</label>
              <div class="col-sm-10">
                <div class="icon-field">
                  <span class="icon">
                    <iconify-icon icon="f7:phone"></iconify-icon>
                  </span>
                  <input type="number" name="no_hp_ortu" class="form-control" placeholder="Masukkan No. HP Orang Tua" value="{{$siswa->no_hp_ortu}}">
...
<script>
$('#formUpdateSiswa').on('submit', function(e) {
    e.preventDefault();
    ...
    $.ajax({
        url: "{{ route('admin.siswa.update', $siswa->id) }}",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
...
function uploadFoto(blob) {
    ...
    $.ajax({
        url: "{{ route('admin.siswa.updateFotoProfil', $siswa->id) }}",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
...
function uploadFotoUnggulan(blob) {
    ...
    $.ajax({
        url: "{{ route('admin.siswa.updateFotoUnggulan', $siswa->id) }}",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
...
$('#btnUbahPassword').on('click', function () {
    Swal.fire({
        ...
        html: `
            ...
            <input type="text" class="swal2-input" value="{{ $siswa->user->password_text }}" readonly>
...
function updatePassword(password) {
    $.ajax({
        url: "{{ route('admin.siswa.updatePassword', $siswa->id) }}",
        type: "POST",
        data: {
            _token: "{{ csrf_token() }}",
            password: password
...
function hapusFoto() {
    $.ajax({
        url: "{{ route('admin.siswa.hapusFoto', $siswa->id) }}",
        type: "POST",
        data: {
            _token: "{{ csrf_token() }}"
        },
