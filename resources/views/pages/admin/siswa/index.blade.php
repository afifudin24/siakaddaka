                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="col-md-4 col-6">
                                <select name="kelas_id" class="form-select" id="select_kelas" onchange="this.form.submit()">
                                    ...
                                    <option value="all" {{ request('kelas_id') == 'all' ? 'selected' : '' }}>Semua
                                    </option>
                                    <option value="null" {{ request('kelas_id') == 'null' ? 'selected' : '' }}>Tanpa Kelas
                                    </option>
                                    @foreach ($kelas as $k)
                                        <option value="{{ $k->id }}"
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-1"
                                                href="javascript:void(0)" id="leaveSelectedBtn">
                                        ...
                                        <li>
                                            <a class="dropdown-item text-danger d-flex align-items-center gap-1"
                                                href="javascript:void(0)" id="deleteSelectedBtn">
 ...
 <iconify-icon icon="ion:search-outline" class="icon"></iconify-icon>
    ...
    <input type="hide" id="actiontype" name="actiontype">
                        ...
                        <table class="table basic-border-table" style="width:100%">
                            <thead>
                                <tr>
                                    <th style="width : 5px !important; padding: 0.9rem 7px;" class="text-center ">
                                        <input style="line-height: 1 !important" class="form-check-input " type="checkbox" id="checkAll2">
                                    </th>
                                    ...
                                    <th scope="col" style="width : 220px !important;" class="d-md-table-cell d-none">NAMA & KELAS</th>
                                    <th scope="col" style="width : 150px !important;" class="d-md-none d-table-cell">NAMA & KELAS</th>
                            ...
                            <tbody>
                                @foreach ($siswa as $s)
                                    <tr>
                                        <td style="width: 5px !important; padding: 7px; text-align: center">
                                            <input class="form-check-input check-data" type="checkbox" name="selected[]"
                                                value="{{ $s->id }}">
                                        </td>
                                        ...
                                        <td class="d-none d-md-table-cell" style="width:220px !important; text-align: left;">{{ $s->nama }} <br>
                                            <span class="badge bg-info-600 p-1 radius-4 text-white"
