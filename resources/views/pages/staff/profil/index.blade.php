...
function uploadFoto(blob) {
    ...
    $.ajax({
        url: "{{ route('staff.updateFotoProfil') }}",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
...
function uploadFotoUnggulan(blob) {
    ...
    $.ajax({
        url: "{{ route('staff.updateFotoUnggulan') }}",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
...
function updatePassword(password) {
    $.ajax({
        url: "{{ route('staff.profil.updatePassword') }}",
        type: "POST",
        data: {
            _token: "{{ csrf_token() }}",
            password: password
...
function hapusFoto() {
    $.ajax({
        url: "{{ route('staff.profil.hapusFoto') }}",
        type: "POST",
        data: {
            _token: "{{ csrf_token() }}"
        },
